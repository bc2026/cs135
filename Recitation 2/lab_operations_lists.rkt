...
;; ((p and q and r) or (p and not q and r) or (not p and q and r) or (not p and not q and r) or (p and q and not r) or (p and not q and not r) or (not p and q and not r) and (not p q r)
(define (3majority p q r)
  (or (and p q r) (and p (not q) r) (and (not p) q r) (and (not p) (not q) r) (and p q (not r)) (and p (not q) (not r)) (and (not p) q (not r)) (not p q r))
)
...
(define (quad-roots a b c)
  ...
  (define (pos-quad-roots a b c)
    (/ (+ (* -1 b) (sqrt (- (* b b) (* 4 a c)))) (* 2 a))
  )

  (define (neg-quad-roots a b c)
    (/ (- (* -1 b) (sqrt (- (* b b) (* 4 a c)))) (* 2 a))
  )

  (append (list (neg-quad-roots a b c)) (list (pos-quad-roots a b c)))
